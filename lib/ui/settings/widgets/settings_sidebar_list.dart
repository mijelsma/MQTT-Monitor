...
class SettingsSidebarList extends StatelessWidget {
  const SettingsSidebarList({super.key, required this.borderColor, required this.items, required this.current, required this.onSelect});
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: isSelected ? [BoxShadow(color: item.gradient.first.withValues(alpha: 0.35), blurRadius: 8, offset: const Offset(0, 3))] : null,
                  ),
                ...
                Text(
                  item.label,
                  style: TextStyle(fontSize: 14, fontWeight: isSelected ? FontWeight.w600 : FontWeight.w400, color: textColor),
                ),
                const Spacer(),
