...
abstract final class SettingsKeys {
  ...
  static final hideStatusBar = StateKey.boolean('settings.hideStatusBar');
  ...
  static final List<StateKey> all = [themeMode, hideStatusBar, showActivity, persistLayout, language, brokers];
}
