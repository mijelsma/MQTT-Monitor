class ClientCertificateConfig {
  ...
  ClientCertificateConfig copyWith({
    ...
    bool clearRootCa = false,
    bool clearClientPrivateKey = false,
    bool clearClientCertificate = false,
  }) {
    return ClientCertificateConfig(
      rootCaPath: clearRootCa ? null : rootCaPath ?? this.rootCaPath,
      clientPrivateKeyPath: clearClientPrivateKey
          ? null
          : clientPrivateKeyPath ?? this.clientPrivateKeyPath,
      clientCertificatePath: clearClientCertificate
          ? null
  ...
  factory ClientCertificateConfig.fromJson(Map<String, dynamic> json) {
    return ClientCertificateConfig(
      rootCaPath: json['rootCaPath'] as String?,
      clientPrivateKeyPath: json['clientPrivateKeyPath'] as String?,
      clientCertificatePath: json['clientCertificatePath'] as String?,
    );
  }

  Map<String, dynamic> toJson() => {
    if (rootCaPath != null) 'rootCaPath': rootCaPath,
