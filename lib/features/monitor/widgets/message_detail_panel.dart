        ...
        children: [
          ...
          _TopicHeader(
            ...
            onDelete: isHistorical
                ? null
                : () {
                    context.read<MonitorWorkspaceController>().deleteTopic(
                      node,
                    );
...
class _PropertiesCard extends StatelessWidget {
  ...
  String? _computeRate(BuildContext context) {
    ...
    final sampleSize = context
        .read<HistoryPreferencesRepository>()
        .rateSampleSize;
      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          ...
          child: Icon(
            ...
            size: 14,
            color: _hovering ? tokens.error : tokens.textTertiary,
          ),
        ),
      ),
    );
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: widget.isHistorical
                    ? tokens.warning.withValues(alpha: 0.6)
                    : tokens.border,
