...
class MonitorViewModel extends ChangeNotifier {
  ...
  MqttProtocolVersionModel? get activeProtocol => _mqtt.activeProtocol;
  BrokerEntryModel? get activeBroker => _brokers.activeBroker;
  ...
  List<PublishShortcutModel> get availableShortcuts {
  ...
  Future<void> addBroker(BrokerEntryModel entry) async => _brokers.add(entry);
  Future<void> updateBroker(BrokerEntryModel updated) async => _brokers.update(updated);
