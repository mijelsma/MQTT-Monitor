...
class DashboardPreferencesRepository extends ChangeNotifier {
  ...
  static const ChartTypeModel defaultChartType = ChartTypeModel.line;
  static const InterpolationModeModel defaultInterpolation = InterpolationModeModel.curved;

  final PreferencesStore _store;

  double _dotSize = defaultDotSize;
  int _cardColor = defaultCardColor;
  ChartTypeModel _chartType = defaultChartType;
  InterpolationModeModel _interpolation = defaultInterpolation;
  int _maximumSamples = DashboardSeriesPolicy.defaultSamples;

  double get dotSize => _dotSize;
  int get cardColor => _cardColor;
  ChartTypeModel get chartType => _chartType;
  InterpolationModeModel get interpolation => _interpolation;
  ...
  Future<void> initialize() async {
    ...
    _chartType = _decodeEnum(_store.get(chartTypeKey), ChartTypeModel.values, defaultChartType);
    _interpolation = _decodeEnum(_store.get(interpolationKey), InterpolationModeModel.values, defaultInterpolation);
  ...
  Future<void> setChartType(ChartTypeModel value) async {
  ...
  Future<void> setInterpolation(InterpolationModeModel value) async {
