...
class ShortcutRepository extends ChangeNotifier {
  ...
  List<PublishShortcut> _shortcuts = const [];
  Set<String> _knownBrokerIds = const {};

  List<PublishShortcut> get shortcuts => _shortcuts;

  List<PublishShortcut> shortcutsForBroker(String brokerId) {
  ...
  Future<void> add(PublishShortcut shortcut) async {
  ...
  Future<void> update(PublishShortcut updated) async {
  ...
  Future<void> synchronizeBrokers() async {
    ...
    final shortcuts = <PublishShortcut>[];
    var changed = false;
  ...
  Future<void> _persist(List<PublishShortcut> shortcuts) async {
  ...
  void _validateAll(List<PublishShortcut> shortcuts) {
    final ids = <String>{};
...
List<PublishShortcut> _decode(Object? raw) {
  ...
  return decoded.map((value) => PublishShortcut.fromJson(Map<String, dynamic>.from(value as Map))).toList(growable: false);
}
