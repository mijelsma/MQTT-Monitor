...
class VariableRepository extends ChangeNotifier {
  ...
  List<EnvironmentVariableModel> _variables = const [];
  Map<String, String> _values = const {};
  Set<String> _knownBrokerIds = const {};

  List<EnvironmentVariableModel> get variables => _variables;
  Map<String, String> get values => _values;

  List<EnvironmentVariableModel> variablesForBroker(String? brokerId) {
  ...
  Future<void> add(EnvironmentVariableModel variable) async {
  ...
  Future<void> update(String oldName, EnvironmentVariableModel updated) async {
  ...
  Future<void> synchronizeBrokers() async {
    ...
    final variables = <EnvironmentVariableModel>[];
  ...
  Future<void> _persistVariables(List<EnvironmentVariableModel> variables) => _writeSnapshot(variables, _values);
  Future<void> _persistValues(Map<String, String> values) => _writeSnapshot(_variables, values);

  Future<void> _writeSnapshot(List<EnvironmentVariableModel> variables, Map<String, String> values) async {
  ...
  void _validateVariables(List<EnvironmentVariableModel> variables) {
    final names = <String>{};
  ...
  void _validateVariable(EnvironmentVariableModel variable) {
...
({List<EnvironmentVariableModel> variables, Map<String, String> values}) _decodeSnapshot(Object? raw) {
  ...
  final variables = definitions.map((value) => EnvironmentVariableModel.fromJson(Map<String, dynamic>.from(value as Map))).toList(growable: false);
