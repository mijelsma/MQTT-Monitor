...
void main() {
  ...
  test('current dashboard schema round-trips cards, layout CRUD, and active selection', () async {
    ...
    final layout = DashboardLayout(id: 'layout', title: 'Layout', brokerIds: const ['a'], cards: [card]);
  ...
  test('broker deletion removes dynamic keys and repairs scoped layouts', () async {
    ...
    await repository.setLayouts([
      DashboardLayout(id: 'a-only', title: 'A', brokerIds: const ['a'], cards: [_card('a-card')]),
      DashboardLayout(id: 'shared', title: 'Shared', brokerIds: const ['a', 'b']),
      DashboardLayout(id: 'global', title: 'Global'),
    ]);
