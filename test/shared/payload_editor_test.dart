...
import 'package:mqtt_monitor/shared/controllers/highlighting_controller.dart';
...
void main() {
  testWidgets('validation errors do not overflow the JSON line-number gutter', (tester) async {
      ...
      MaterialApp(
        ...
        home: Scaffold(
          body: SizedBox(
            width: 500,
            height: 180,
            child: PayloadEditor(controller: controller, format: PayloadFormat.json, onFormatChanged: (_) {}, validationError: 'Ln 7, col 1: Unexpected character.'),
          ),
        ),
      ),
    );
